...
ブロック内の **NExT Post Template** ブロックでレイアウトを設計します。ツールバーのアイコンでグリッド / リストを切り替え、インスペクターでカラム数とブロック間隔を設定できます。
...
投稿テンプレートブロックを選択し、インスペクターの「ブロックの間隔」から設定してください。フロントエンドのインラインスタイルに直接反映されます。
